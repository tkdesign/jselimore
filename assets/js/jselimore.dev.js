const jsElimore = function(selector, context = document) {
    ...
    return {
        ...
        ellipsis(opts) {
            let fullTxt = el.innerText, fullHtml = el.innerHTML, text_one = fullTxt.substr(0, this.options.maxLength), more_btn = '<a href="javascript:;" class="elimore_show">' + this.options.moreText + "</a>";
            el.innerHTML = "";
...
//# sourceMappingURL=jselimore.dev.js.map